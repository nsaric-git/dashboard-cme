...
# ----------------------
st.set_page_config(
    page_title="WBE — Tendances temporelles",
    page_icon="🧪",
    layout="wide",
...
def render_timeseries_chart(df_view, show_trend, normalize, df_mkt, start_d, end_d,
    ...
    st.plotly_chart(fig1, use_container_width=True, key=f"{key_prefix}chart_raw")
        ...
        if pur_q.empty:
            ...
            if df_norm_plot.empty:
                ...
                with col1:
                    ...
                    st.plotly_chart(fig2, use_container_width=True, key=f"{key_prefix}chart_norm")
                ...
                with col2:
                    ...
                    st.plotly_chart(fig3, use_container_width=True, key=f"{key_prefix}chart_purity")
...
def render_comparison_with_map(df_view, stup_name, key_prefix=""):
    ...
    for analyte in analytes:
        ...
        with col_box:
            ...
            st.plotly_chart(fig, use_container_width=True, key=f"{key_prefix}boxplot_{analyte}")
